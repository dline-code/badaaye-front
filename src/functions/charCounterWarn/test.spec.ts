...
describe('count characteres number',() => {
    ...
    it('should return 0 if the lenght of character is more than 255', () => {
        const charLacky =  charCounterWarn('dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code dline-code');
